...
DEBUG = env('DEBUG')
TEST_ERROR_VIEW = DEBUG or env('TEST_ERROR_VIEW', default=True)
...
RAVEN_CONFIG = {
    'dsn': env('SENTRY_DSN', default='https://aaa:bbb@sentry.io/123'),
}

# SECURITY WARNING!
# This will be publicly visible in the error page javascript. Do not include DSN secret here.
SENTRY_PUBLIC_DSN = env('SENTRY_PUBLIC_DSN', default='bbbb')
