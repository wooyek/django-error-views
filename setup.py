...
version = get_version("src", "django_error_views", "__init__.py")
...
setup(
    name='django-error-views',
    version=version,
    description="""Verbose error views with minimal context and integration with Sentry""",
    ...
    entry_points={
        'console_scripts': [
            'django_error_views=django_error_views.cli:main'
        ]
    },
